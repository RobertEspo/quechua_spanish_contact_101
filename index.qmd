...
# ---- Plot ----
ggplot() +
  # Lingua franca bar below main bars
...
Everything before this slide is solid enough. Everything after this slide is notes/drafts.

Here we'll put a bunch of lexical borrowings have them determine what domains of life they mostly come from. We'll make reference to @van2016loan @coetsem2000general. Borrowing vs imposition.

## Grammatical Borrowings

Here we'll put borrowing of suffixes.

## Phonological/Phonetic Features

Here we'll put phonological inventories of Spanish & Quechua and determine where transfer may occur. We'll make reference to @van2016loan @coetsem2000general. Borrowing vs imposition.
...
favors adverbials and objects in preverbal position.
adverbials and prepositional phrases tend to appear utterance-initial.
frequent use of analytical verbal expressions
  hacer + infinitive = causative
  saber + infinitive = habitual aspect
  dar + gerund = benefactive
  venir + gerund = perfective
dequeísmo
...
Not sure how to incorporate this yet, but so they get an idea of what we're working with in terms of what it sounds like.
