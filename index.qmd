...
::: fragment
- Based on the [Maximize Common Ground]{.emph} [@hawkins2024bilingualism] principle, what hypotheses can we make about [expressing contrastive focus]{.emph} in Andean Spanish?
:::
...
2. Demonstrate what a change in [peak height]{.emph} would look like on the [subject]{.emph}.
3. Demonstrate what a change in [peak aligment]{.emph} would look like on the [subject]{.emph}.
...
[Cuzco Quechua-Spanish bilingual]{.small}

![](assets/cuzco_bilingual.bmp)
